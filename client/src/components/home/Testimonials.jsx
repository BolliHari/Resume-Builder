...
const Testimonials = () => {
  ...
  return (
    <>
        <div id='testimonials' className='my-10 flex flex-col items-center scroll-mt-12'>
            <div className="flex items-center gap-2 text-sm text-green-400 bg-green-400/10 rounded-full px-6 py-1.5">
                    <BookUserIcon className='size-4 stroke-green-500'/>
