...
const Footer = () => {
  return (
    <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full text-slate-800 mt-40 bg-gradient-to-r from-white via-green-200 to-white">
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+1-234-567-890</p>
                            <p>bollihari18@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="#">Bolli Hari</a>. All Right Reserved.
            </p>
        </footer>
  )
}
